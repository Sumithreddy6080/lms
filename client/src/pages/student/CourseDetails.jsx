...
const CourseDetails = () => {
  ...
  const fetchCourseData = async () => {
    try {
      ...
      toast.error(error.message || 'Something went wrong while fetching course data');
    }
  };
  ...
  const enrollCourse = async () => {
    try {
      ...
      toast.error(error.message || 'Something went wrong while enrolling in the course');
    }
  };
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-28 pt-20 text-left  ">
        ...
        <div className="max-w-xl z-10 text-gray-500 ">
          <h1 className="md:text-[40px] text-[26px] font-semibold text-gray-800  ">{courseData.courseTitle}</h1>
          <p
        ...
        <div className="max-w-[424px] z-10 shadow-[0px 4px 15px 2px rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5 ">
            ...
            <button
              ...
              className="md:mt-6 mt-4 w-full py-3 rounded-2xl bg-blue-600 text-white font-medium"
            >
              {isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}
            </button>
            <div className="md:text-xl text-lg pt-2 font-medium text-gray-800 ">
